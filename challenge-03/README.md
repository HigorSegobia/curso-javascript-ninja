...
*/
var pessoa = {nome: 'Higor', sobrenome:'Segobia', sexo:'Masculino', idade:20, altura: 1.90, peso: 100, andando: false, caminhouQuantosMetros: 0}
...
*/
pessoa.nomeCompleto() //'Olá! Meu nome é Higor Segobia'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso() // 'Ola! eu peso 100kg'
...
// Agora, apresente-se ;)
'Olá, eu sou o Higor Segobia , tenho 23 anos , 1.9 meu peso é 100kg e, só hoje, eu já caminhei 9 metros'
```
